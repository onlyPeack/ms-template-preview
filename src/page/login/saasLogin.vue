<template>
    <div class="login-container" @keyup.enter.native="handleLogin">
        <div class="login-container-top" style="width:1200px;margin: auto">
            <top-color v-show="false"></top-color>
            <div class="login-weaper animated bounceInDown" style="margin-right: 0;">
                ...
                <div class="login-border">
                    <div class="login-main">
                        ...
                        <div style="width: 100%;display: flex;flex-direction: row;justify-content: space-between;align-items: center;">
                            ...
                            <div>
<!--                                <span style="color: rgb(252,100,89);font-size: 12px;cursor: pointer;" v-if="activeName == 'user'" @click="activeName = 'code'">免费注册</span>-->
...
<!--        <div class="last_div">Copyright © 2020 梅施云 · 商城后台管理平台 All Rights Reserved   沪ICP备16009044号</div>-->
    </div>
</template>
<script>
...
<style lang="scss">
    ...
    .login-container{
        background-image: url('../../../public/img/bg/SAAS.jpg') !important;
    ...
    @media screen and (max-width: 992px){
        ...
        .login-container-top>.bounceInDown{
