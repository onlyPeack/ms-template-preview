<template>
    <el-dialog :visible.sync="dialogVisible" width="70%" @close="handleClose" :close-on-click-modal="false" :modal-append-to-body="false"
               :before-close="handleClose" title="短信模板选择" append-to-body class="public-dialog">
...
<!--                    </div>-->
                    <div style="width: 100%;background: #ffffff;">
                        ...
                        <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit
                                  highlight-current-row :height="clientHeight" style="height: 100%;position:relative;" @row-click="rowClick"
                                  :default-sort="{prop: 'id', order: 'ascending'}">
                            <el-table-column  type="index">
                            </el-table-column>
                            <el-table-column align="center" prop="templateCode" label="模板编码">
                            </el-table-column>
                            <el-table-column align="center" prop="templateName" label="模板名称">
                            </el-table-column>
                            <el-table-column align="center" prop="instructions" label="说明" width="300">
                            </el-table-column>
                            <el-table-column align="center" prop="templateText" label="模板内容" width="700">
                            </el-table-column>
                        </el-table>
...
<script>
    ...
    import {selectTemplate as page} from '@/api/erp/saas/websiteControl/websiteSetting'
    export default {
        name: 'noteTemplateSelector',
